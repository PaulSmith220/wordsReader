...
"use strict";
var createWordNode = function createWordNode(word, index) {
  var selected = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  return "<div data-num=\"".concat(index, "\" data-orig=\"").concat(word[0], "\" data-trans=\"").concat(word[1], "\" class=\"word-item ").concat(selected && 'selected', "\">").concat(word[0], " - ").concat(word[1], "</div>");
};

/* harmony default export */ __webpack_exports__["a"] = (function (words, lastLine) {
  var list = document.getElementById('lines');

  if (list) {
    list.innerHTML = words.map(function (word, index) {
      return createWordNode(word, index, index === lastLine);
    }).join('\n');
  }
});
;
...
// UNUSED EXPORTS: selectWord, selectNext

// EXTERNAL MODULE: ./src/renderer/setList.js
var setList = __webpack_require__(0);

// CONCATENATED MODULE: ./src/renderer/readCurrentWord.js
var _require = __webpack_require__(2),
    ipcRenderer = _require.ipcRenderer;

/* harmony default export */ var readCurrentWord = (function () {
  var node = document.querySelector('.word-item.selected');

  if (node) {
    var original = node.dataset['orig'];
    var translation = node.dataset['trans'];
    ipcRenderer.send('asynchronous-message', "readWord||[\"".concat(original, "\", \"").concat(translation, "\"]"));
  }
});
;
// CONCATENATED MODULE: ./src/renderer/initPage.js
var initPage_require = __webpack_require__(2),
    initPage_ipcRenderer = initPage_require.ipcRenderer;
...
function selectWord(nextNode) {
  if (nextNode) {
    var selectedNode = document.querySelector('.word-item.selected');
    selectedNode.classList.remove('selected');
    nextNode.classList.add('selected');
    scrollToSelected();
    initPage_ipcRenderer.send('asynchronous-message', "selectLine||".concat(nextNode.dataset['num']));
    return true;
  }
...
function scrollToSelected() {
  ...
  if (selectedNode) {
    var vOffset = selectedNode.offsetTop - parseInt(window.innerHeight / 2);
    window.scrollTo({
      top: vOffset,
      left: 0,
...
function selectNext() {
  var selectedNode = document.querySelector('.word-item.selected');
  var num = parseInt(selectedNode.dataset['num'] || '1');
  var nextNode = document.querySelector(".word-item[data-num=\"".concat(1 + num, "\"]"));

  if (selectWord(nextNode)) {
    readCurrentWord();
  }
}
/* harmony default export */ var initPage = __webpack_exports__["a"] = (function (_ref) {
  ...
  Object(setList["a" /* default */])(words, lastLine);
  ...
  document.getElementById('loadFile').addEventListener('click', function () {
    ...
    //     if (value) {
    var value = ' - ';
    initPage_ipcRenderer.send('asynchronous-message', "loadFile||".concat(value)); //     } else {
...
/* harmony import */ var _initPage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1);
/* harmony import */ var _setList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(0);
/* harmony import */ var _css_main_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(13);
...
/* harmony import */ var _assets_css_all_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(15);
...
var parseCommand = function parseCommand(arg) {
  var _arg$split = arg.split('||'),
      _arg$split2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_arg$split, 2),
      command = _arg$split2[0],
      data = _arg$split2[1];

  return [command, JSON.parse(data)];
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById('play').addEventListener('click', function () {
    ...
    isPlaying && _initPage__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].readCurrentWord();
  });
  ipcRenderer.on('asynchronous-reply', function (event, arg) {
    ...
    switch (command) {
      ...
      case 'wordsUpdated':
        {
          Object(_setList__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(data, config.lastLine);
          break;
        }
      ...
      case 'wordPlayed':
        {
          if (isPlaying) {
            setTimeout(_initPage__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].selectNext, 1000);
          }
...
var ___CSS_LOADER_URL_IMPORT_4___ = __webpack_require__(22);
var ___CSS_LOADER_URL_IMPORT_5___ = __webpack_require__(23);
var ___CSS_LOADER_URL_IMPORT_6___ = __webpack_require__(24);
var ___CSS_LOADER_URL_IMPORT_7___ = __webpack_require__(25);
var ___CSS_LOADER_URL_IMPORT_8___ = __webpack_require__(26);
var ___CSS_LOADER_URL_IMPORT_9___ = __webpack_require__(27);
var ___CSS_LOADER_URL_IMPORT_10___ = __webpack_require__(28);
var ___CSS_LOADER_URL_IMPORT_11___ = __webpack_require__(29);
var ___CSS_LOADER_URL_IMPORT_12___ = __webpack_require__(30);
var ___CSS_LOADER_URL_IMPORT_13___ = __webpack_require__(31);
var ___CSS_LOADER_URL_IMPORT_14___ = __webpack_require__(32);
exports = ___CSS_LOADER_API_IMPORT___(false);
